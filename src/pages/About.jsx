export default function About() {
  return (
    <div className="py-16 px-6 max-w-4xl mx-auto">
      <h2 className="text-4xl font-bold text-amber-800 mb-6 tracking-tight">About ScanLink</h2>
      ...
      <p className="text-zinc-700 leading-relaxed mb-6 text-lg">
        ...
        physical and digital worlds using fully customizable QR codes and an integrated URL shortener. Built with flexibility and precision in mind,
